...
ALTER SEQUENCE PEOPLE_FLOW_RH.AREA_ID_SEQ
    INCREMENT BY 1
    MINVALUE 1
    NO MAXVALUE
    CACHE 20
...
ALTER SEQUENCE PEOPLE_FLOW_RH.NIVEL_HIERARQUICO_ID_SEQ
    INCREMENT BY 1
    MINVALUE 1
    NO MAXVALUE
    CACHE 20
...
ALTER SEQUENCE PEOPLE_FLOW_RH.FAMILIA_CARGO_ID_SEQ
    INCREMENT BY 1
    MINVALUE 1
    NO MAXVALUE
    CACHE 20
...
ALTER SEQUENCE PEOPLE_FLOW_RH.DOCUMENTO_CONTRATO_ID_SEQ
    INCREMENT BY 1
    MINVALUE 1
    NO MAXVALUE
    CACHE 20
