...
-- Auditoria
CREATE INDEX IF NOT EXISTS IDX_AUD_ENTIDADE ON PEOPLE_FLOW_RH.AUDITORIA(ENTIDADE, ENTIDADE_ID);
CREATE INDEX IF NOT EXISTS IDX_AUD_USUARIO ON PEOPLE_FLOW_RH.AUDITORIA(USUARIO_ID);
CREATE INDEX IF NOT EXISTS IDX_AUD_TIMESTAMP ON PEOPLE_FLOW_RH.AUDITORIA(TIMESTAMP);
