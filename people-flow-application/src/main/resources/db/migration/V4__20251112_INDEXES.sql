...
CREATE UNIQUE INDEX IF NOT EXISTS UQ_EMPRESA_CNPJ
    ON PEOPLE_FLOW_RH.EMPRESA (CNPJ)
...
CREATE UNIQUE INDEX IF NOT EXISTS UQ_CANDIDATO_CPF
    ON PEOPLE_FLOW_RH.CANDIDATO (CPF)
    WHERE CPF IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS IDX_CENTRO_CUSTO_EMPRESA ON PEOPLE_FLOW_RH.CENTRO_CUSTO(EMPRESA_ID);
...
CREATE INDEX IF NOT EXISTS IDX_COLAB_CARGO ON PEOPLE_FLOW_RH.COLABORADOR(CARGO_ID);
...
CREATE INDEX IF NOT EXISTS IDX_DOCUMENTO_CONTRATO_CONTRATO
    ON PEOPLE_FLOW_RH.DOCUMENTO_CONTRATO (CONTRATO_ID);
...
-- Área
CREATE UNIQUE INDEX IF NOT EXISTS UQ_IDX_AREA_CODIGO
    ON PEOPLE_FLOW_RH.AREA (CODIGO);

-- Cargo
CREATE UNIQUE INDEX IF NOT EXISTS UQ_IDX_CARGO_CODIGO
    ON PEOPLE_FLOW_RH.CARGO (CODIGO)
    WHERE CODIGO IS NOT NULL;

CREATE INDEX IF NOT EXISTS IDX_CARGO_NIVEL_HIERARQUICO
    ON PEOPLE_FLOW_RH.CARGO (NIVEL_HIERARQUICO_ID);

CREATE INDEX IF NOT EXISTS IDX_CARGO_FAMILIA_CARGO
    ON PEOPLE_FLOW_RH.CARGO (FAMILIA_CARGO_ID);

CREATE INDEX IF NOT EXISTS IDX_CARGO_DEPARTAMENTO
    ON PEOPLE_FLOW_RH.CARGO (DEPARTAMENTO_ID)
    WHERE DEPARTAMENTO_ID IS NOT NULL;

-- Departamento → Área
CREATE INDEX IF NOT EXISTS IDX_DEPARTAMENTO_AREA
    ON PEOPLE_FLOW_RH.DEPARTAMENTO (AREA_ID)
...
CREATE INDEX IF NOT EXISTS IDX_DEPARTAMENTO_ATIVO 
    ON PEOPLE_FLOW_RH.DEPARTAMENTO(EMPRESA_ID) 
    WHERE EXCLUIDO_EM IS NULL;
