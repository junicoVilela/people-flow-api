...
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.COLABORADOR (
    ...
    DATA_DEMISSAO DATE,
    STATUS TEXT NOT NULL DEFAULT 'ativo',
    CARGO_ID BIGINT, -- Cargo atual do colaborador
...
-- Área de classificação de cargos (ex: Tecnologia, Comercial, Operações)
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.AREA (
    ID        BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- Nível hierárquico do cargo (ex: Júnior, Pleno, Sênior, Coordenador, Gerente)
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.NIVEL_HIERARQUICO (
    ID        BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
-- Família de cargos agrupa cargos similares (ex: Família Engenharia, Família Comercial)
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.FAMILIA_CARGO (
    ID        BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    NOME      VARCHAR(100) NOT NULL,
    DESCRICAO VARCHAR(500),
    CRIADO_POR        BIGINT,
...
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.CARGO (
    ...
    NOME                 VARCHAR(150) NOT NULL,
    DESCRICAO            VARCHAR(500),
    NIVEL_HIERARQUICO_ID BIGINT,
    FAMILIA_CARGO_ID     BIGINT,
    DEPARTAMENTO_ID      BIGINT,
    CRIADO_POR        BIGINT,
    CRIADO_EM         TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp(),
    ATUALIZADO_POR    BIGINT,
...
-- Documentos digitais vinculados ao contrato (PDFs, aditivos, etc.)
CREATE TABLE IF NOT EXISTS PEOPLE_FLOW_RH.DOCUMENTO_CONTRATO (
    ID  BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
